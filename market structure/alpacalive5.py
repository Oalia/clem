...
def runstrategy():
    ...
    storekwargs = dict(
        key_id='PK336EARRLVLRSJ2BWDJ',
        secret_key='BUjwqSDgF3sXFmBBIskXnAb0ktklU9gqAWssLtto',
        paper= True
    )

    store = alpaca_backtrader_api.AlpacaStore(key_id=ALPACA_KEY_ID,
    ...
    # timeframe = bt.TimeFrame.TFrame("1hr")
    ...
    data0 = DataFactory(dataname="AMC",
...
#     parser.add_argument('--keyid', default="PK336EARRLVLRSJ2BWDJ",
#                         required=False, action='store',
#                         help='Alpaca API key id')

#     parser.add_argument('--secretkey', default="BUjwqSDgF3sXFmBBIskXnAb0ktklU9gqAWssLtto",
#                         required=False, action='store',
...
#     parser.add_argument('--data0', default="TSLA",
#                         required=False, action='store',
