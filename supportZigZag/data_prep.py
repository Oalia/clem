...
from support_resistance import createZigZagPoints, resistanceFinder
from candlestick import get_candle_sticks

def arguement_parser(tickers, period, interval, dif, time, number, min):
    """
    tickers: SPY500
    period: 5d
    interval: 1m
    ...
    parser.add_argument('-p', '--period', default='5d', type=str, required=False,
    ...
    parser.add_argument('--time', default='1200', type=int, required=False,
...
def get_quotes_API():
    ...
    -------
    ticker
            A list of tickers called
    ticker_df
            A dataframe of returned data
    """
